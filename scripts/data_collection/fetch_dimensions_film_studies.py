"""
fetch_dimensions_film_studies.py
---------------------------------
Fetches the film_studies bibliographic dataset from Dimensions.ai (1975-2024)
using keyword search in title and abstract, year by year.

Output files saved to data/:
  1. Dimensions_film_studies_1975_2024_raw.json.gz
  2. Dimensions_film_studies_1975_2024.parquet
