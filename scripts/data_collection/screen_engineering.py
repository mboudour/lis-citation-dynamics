"""
screen_engineering.py
=====================
Screens 10 Engineering keyword candidates from Dimensions.ai (1975-2024).
...
Results are saved incrementally to screen_engineering_report.csv.

Run from the directory containing Dim_key.txt:

    python screen_engineering.py
...
CANDIDATES = [
    ("corrosion_protection",    ["corrosion protection"]),
    ("heat_transfer",           ["heat transfer"]),
    ("structural_health_monitoring", ["structural health monitoring"]),
    ...
    ("concrete_durability",     ["concrete durability"]),
    ("robotics_control",        ["robotics control"]),
    ("signal_processing",       ["signal processing"]),
]

REPORT_CSV = Path("screen_engineering_report.csv")
...
print("\n\n" + "="*70)
print("ENGINEERING CANDIDATES — SUMMARY (sorted by gcc_fraction)")
print("="*70)
